...
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -o Makefile PoetryGenerator.pro
#############################################################################
...
CXXFLAGS      = -pipe -I/usr/local/include/SDL2 -D_REENTRANT -O3 -msse -msse2 -msse3 -march=native -march=native -O2 -std=gnu++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -I/home/i7620560/NGL/include -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtOpenGL -I/opt/Qt5.7.0/5.7/gcc_64/include/QtWidgets -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -Imoc -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-z,origin -Wl,-rpath,\$$ORIGIN/L/home/i7620560/NGL/lib -Wl,-rpath,/home/i7620560/NGL/lib -Wl,-rpath,/opt/Qt5.7.0/5.7/gcc_64/lib
...
Makefile: PoetryGenerator.pro .qmake.cache /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile PoetryGenerator.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/camera.hpp include/cmd.hpp include/common.hpp include/fft.hpp include/file.hpp include/font.hpp include/framebuffer.hpp include/interp.hpp include/light.hpp include/markovChain.hpp include/markovChainMatrix.hpp include/markovEdge.hpp include/markovState.hpp include/matrices.hpp include/notes.hpp include/printer.hpp include/range.hpp include/sampler.hpp include/shape.hpp include/sim_time.hpp include/slotmap.hpp include/sphere.hpp include/util.hpp include/visualiser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/camera.cpp src/cmd.cpp src/common.cpp src/fft.cpp src/file.cpp src/font.cpp src/framebuffer.cpp src/interp.cpp src/markovChain.cpp src/markovChainMatrix.cpp src/markovEdge.cpp src/markovState.cpp src/matrices.cpp src/notes.cpp src/printer.cpp src/range.cpp src/sampler.cpp src/shape.cpp src/sim_time.cpp src/slotmap.cpp src/sphere.cpp src/util.cpp src/visualiser.cpp $(DISTDIR)/
...
obj/markovChain.o: src/markovChain.cpp include/markovChain.hpp \
		/home/i7620560/NGL/include/ngl/Random.h \
		/home/i7620560/NGL/include/ngl/Colour.h \
		/home/i7620560/NGL/include/ngl/Types.h \
		/home/i7620560/NGL/include/ngl/glew.h \
