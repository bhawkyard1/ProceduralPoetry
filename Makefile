...
OBJECTS       = obj/main.o \
		...
		obj/util.o \
		obj/visualiser.o
DIST          = PoetryGenerator.pro include/camera.hpp \
		include/cmd.hpp \
		include/common.hpp \
		include/fft.hpp \
		include/file.hpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/camera.hpp include/cmd.hpp include/common.hpp include/fft.hpp include/file.hpp include/font.hpp include/framebuffer.hpp include/light.hpp include/markovChain.hpp include/markovChainMatrix.hpp include/markovEdge.hpp include/markovState.hpp include/matrices.hpp include/notes.hpp include/physicsvars.hpp include/printer.hpp include/range.hpp include/sampler.hpp include/shape.hpp include/sim_time.hpp include/slotmap.hpp include/sphere.hpp include/util.hpp include/visualiser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/camera.cpp src/cmd.cpp src/common.cpp src/fft.cpp src/file.cpp src/font.cpp src/framebuffer.cpp src/markovChain.cpp src/markovChainMatrix.cpp src/markovEdge.cpp src/markovState.cpp src/matrices.cpp src/notes.cpp src/physicsvars.cpp src/printer.cpp src/range.cpp src/sampler.cpp src/shape.cpp src/sim_time.cpp src/slotmap.cpp src/sphere.cpp src/util.cpp src/visualiser.cpp $(DISTDIR)/
