...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/common.hpp include/file.hpp include/framebuffer.hpp include/markovChain.hpp include/markovChainMatrix.hpp include/markovEdge.hpp include/markovState.hpp include/matrices.hpp include/printer.hpp include/sim_time.hpp include/slotMap.hpp include/util.hpp include/visualiser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/common.cpp src/file.cpp src/framebuffer.cpp src/markovChain.cpp src/markovChainMatrix.cpp src/markovEdge.cpp src/markovState.cpp src/matrices.cpp src/printer.cpp src/sim_time.cpp src/slotMap.cpp src/util.cpp src/visualiser.cpp $(DISTDIR)/
