...
CXXFLAGS      = -pipe -pthread -I/usr/local/include/SDL2 -D_REENTRANT -O3 -msse -msse2 -msse3 -march=native -O2 -std=gnu++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
LIBS          = $(SUBLIBS) -pthread -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf -L/home/i7620560/NGL/lib -l NGL -ltiff -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/camera.hpp include/cmd.hpp include/common.hpp include/fft.hpp include/file.hpp include/font.hpp include/framebuffer.hpp include/interp.hpp include/light.hpp include/markovChain.hpp include/markovChainMatrix.hpp include/markovEdge.hpp include/markovState.hpp include/matrices.hpp include/notes.hpp include/physicsvars.hpp include/printer.hpp include/range.hpp include/sampler.hpp include/shape.hpp include/sim_time.hpp include/slotmap.hpp include/sphere.hpp include/util.hpp include/visualiser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/camera.cpp src/cmd.cpp src/common.cpp src/fft.cpp src/file.cpp src/font.cpp src/framebuffer.cpp src/interp.cpp src/markovChain.cpp src/markovChainMatrix.cpp src/markovEdge.cpp src/markovState.cpp src/matrices.cpp src/notes.cpp src/physicsvars.cpp src/printer.cpp src/range.cpp src/sampler.cpp src/shape.cpp src/sim_time.cpp src/slotmap.cpp src/sphere.cpp src/util.cpp src/visualiser.cpp $(DISTDIR)/
...
obj/interp.o: src/interp.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/interp.o src/interp.cpp

obj/markovChain.o: src/markovChain.cpp 
...
obj/markovState.o: src/markovState.cpp 
...
obj/notes.o: src/notes.cpp include/notes.hpp \
		...
		/home/i7620560/NGL/include/ngl/Vec3.h \
		include/common.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/notes.o src/notes.cpp
