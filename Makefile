...
CC            = clang
CXX           = clang++
DEFINES       = -DQT5BUILD -DNGL_DEBUG -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -O2 -std=gnu++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -I/home/i7620560/NGL/include -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -Imoc -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-clang
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/home/i7620560/NGL/lib -l NGL -ltiff -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/common.hpp include/file.hpp include/framebuffer.hpp include/markovChain.hpp include/markovChainMatrix.hpp include/markovEdge.hpp include/markovState.hpp include/matrices.hpp include/printer.hpp include/slotMap.hpp include/util.hpp include/visualiser.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/common.cpp src/file.cpp src/framebuffer.cpp src/markovChain.cpp src/markovChainMatrix.cpp src/markovEdge.cpp src/markovState.cpp src/matrices.cpp src/printer.cpp src/slotMap.cpp src/util.cpp src/visualiser.cpp $(DISTDIR)/
...
obj/markovEdge.o: src/markovEdge.cpp 
...
obj/visualiser.o: src/visualiser.cpp include/visualiser.hpp \
